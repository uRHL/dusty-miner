...
// --------------------------------------
int computeSpeed(){
  float acceleration = slope*INERTIA + gas_status*GAS_POWER + brake_status*BRAKE_POWER;
  //speed = speed_0 + acceleration*time; 
  
    
  speed += acceleration/10;  
  //Map input value [0, 70] into output range [0, 255]  
  analogWrite(SPD_PIN_OUT, ((speed/MAX_SPEED)*255));  
  return 1;
